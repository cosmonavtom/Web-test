...
pasta_changer = ChangePasta('Карбонара')
print(pasta_changer.set_new_cost_price('Карбонара', 200))
print(pasta_changer.set_new_sale_price('Карбонара', 300))
print(pasta_changer.set_ingredients('Карбонара', "чесночный соус", "колбаса", "шампиньоны", "сыр моцарелла", "базилик"))
print(pasta_changer.add_to_menu('Карбонара'))
removed_data, new_menu = ChangePasta.remove_from_menu('Карбонара')
print(removed_data)
print(new_menu)
print(ChangePasta.remove_from_menu('Карбонара'))
