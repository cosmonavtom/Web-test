...
class MenuPasta(PastaProduct):
    menu = {
        "Карбонара": [100, 150, ['Спагетти', 'Соус из яиц и сыра "Пекарино Романо"', 'Бекон', 'Чёрный перец']],
        "Болоньезе": [80, 120, ["Тальятелле", "Томатный соус", "Мясной фарш" , "Томаты", "Морковь", "Вино"]],
        "Фетучини": [110, 155, ["Фетучини", "Грибной соус", "Пармезан", "Сливочное масло", "Оливковое масло"]],
    }
